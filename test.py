...
from tools.maps_tool import ors_geocode

res = ors_geocode("Grønnegata 35, 9008 Tromsø, Norway", "NO")
print("\n \n ORS Geocoding Tool Test \n Query: Grønnegata 35, 9008 Tromsø, Norway, NO \n Results \n")
print(res)

res = ors_geocode("Grønnegata 35, 9008 Tromsø, Norway", "NO", 69.6580484, 18.9375623)
print("\n \n ORS Geocoding Tool Test \n Query: Grønnegata 35, 9008 Tromsø, Norway, NO, 69.6580484, 18.9375623 \n Results \n")
print(res)
